...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentLoggedInAgentId = typeof PHP_currentLoggedInAgentId !== 'undefined' ? PHP_currentLoggedInAgentId : null;
    ...
    const agentName = typeof PHP_currentLoggedInAgentName !== 'undefined' ? PHP_currentLoggedInAgentName : "Agente SCI";
    ...
    const agentSoundFilePath = `/public/agent/sounds/notification.mp3`;
    ...
    function startAgentMessageStream(initialLastTimestamp = 0) { 
        ...
        const streamUrl = `${API_BASE_URL}/common/stream_messages.php?chat_id=${encodeURIComponent(currentOpenUserEmail)}&initial_ts=${initialLastTimestamp}`; 
